...
const problems: Record<string, Problem> = {
  'low-testosterone': {
    ...
    what: 'Testosterone is the main male hormone. It quietly powers your energy, mood, libido, muscle, and even sharp thinking. A “normal” lab range is wide — being at the bottom of normal often feels far from normal.',
    whyMatters:
    ...
    retest:
      'Re-test in 3 months. Always go in the morning — testosterone peaks then.',
  ...
  'low-vit-d': {
    ...
    actions: [
      ...
      },
      {
        ...
        detail: 'Aim for 50–80 ng/mL. Above that doesn’t add benefit.',
      },
    ],
  ...
  'high-ldl': {
    ...
    what: 'LDL particles carry cholesterol from the liver to your cells. When there’s too much, they slip into the wall of arteries and start a slow process of plaque buildup — the root cause of most heart attacks.',
    whyMatters:
  ...
  'insulin-resistance': {
    ...
    what: 'Insulin is the hormone that moves sugar out of your blood. When cells stop listening, your pancreas pumps out more to compensate. HbA1c can still look fine for years while this is happening underneath.',
    whyMatters:
