          ...
          >
            ...
            <div className="flex items-start gap-3 px-6 pt-6 pb-4 border-b border-line/70">
              <div className="flex-1 min-w-0">
                <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-blue-700 mb-1">
                  {doc.eyebrow}
                </div>
                <h2
                  id={titleId}
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              {doc.sections.map((s) => (
                <section key={s.heading}>
                  <h3 className="text-[10px] font-bold uppercase tracking-[0.16em] text-blue-700 mb-2">
                    {s.heading}
                  </h3>
                  {s.paragraphs.map((p, i) => (
                    <p
                      key={i}
                      className="text-[13.5px] leading-relaxed text-ink-soft mt-2 first:mt-0"
                    >
                      {p}
                    </p>
                  ))}
              ...
              <p className="text-[11px] text-muted leading-relaxed pt-3 border-t border-line/70">
