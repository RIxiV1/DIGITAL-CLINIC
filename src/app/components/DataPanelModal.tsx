          ...
          >
            ...
            <div className="flex items-start gap-3 px-6 pt-6 pb-4 border-b border-line/70">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-eyebrow font-bold uppercase tracking-[0.18em] text-indigo-700 mb-0.5">
                  Privacy
                </div>
                <h2
                  id={titleId}
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              ...
              {wiped ? (
                <div className="rounded-[14px] bg-good-soft border border-good/30 p-4 text-meta text-good leading-relaxed">
                ...
                <div className="rounded-[14px] bg-concern-soft border border-concern/30 p-4 space-y-3">
                  <div className="text-meta leading-relaxed text-ink">
...
function StatRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between px-4 py-2.5">
      <span className="text-footnote uppercase tracking-[0.1em] font-bold text-muted">
        {label}
      </span>
      <span className="font-display text-ui-sm text-ink tabular-nums">
        {value}
      </span>
    </div>
  );
